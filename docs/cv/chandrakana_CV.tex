...
VP of R\&D, Certora Inc., June 2026 - current \\
Affiliate Assistant Professor, UW, Seattle, January 2023 - present \\

Director of US R\&D, Certora Inc., December 2023 - June 2026 \\
...
\begin{enumerate}
  ...
  \item Oliver Flatt, Anjali Pal, Yihong Zhang, Ryan Tjoa, Kirsten Graham , Alex Fischman, \textbf{Chandrakana Nandi}, Eli Rosenthal, Zachary Tatlock, Haobin Ni. \\
  Efficient Extraction for Effectful E-Graphs, OOPSLA 2026. \\

  \item Andrew Cheung, \textbf{Chandrakana Nandi}, Sorin Lerner. \\
  Conditional Rewrite Rule Synthesis with E-Graphs and Implication Propagation (Short Paper), FMCAD 2026. \\

  \item Noam Har Tuv, Cynthia Richey, \textbf{Chandrakana Nandi|, Hila Peleg. \\
  "What Led to this Change?'" Organizing Code Diffs Using Semantic Information, VL/HCC 2026. \\

  \item Valkyrie Savage, Harrison Goldstein, Nora Pusok, Jia Yi Ren, Bhaskar Dutt, \textbf{Chandrakana Nandi}, Lora Oehlberg. \\
    FEDT: Supporting Experiment Design and Execution in HCI Fabrication Research, UIST 2025. \\

  \item Yumeng He, \textbf{Chandrakana Nandi}, Sreepathi Pai. \\
    Formalizing Linear Motion G-code for Invariant Checking and Differential Testing of Fabrication Tools, OOPSLA 2025. \\
...
\item POPL 2027 program committee (PC)
\item OOPSLA 2026 program committee (PC)
\item TACO 2025 journal reviewer
\item ASPLOS 2026 external review committee (ERC)
\item ASPLOS 2025 external review committee (ERC)
\item PLDI 2025 program committee (PC)
\item WITS 2025 program committee (PC)
\item TSE 2024 journal reviewer
\item EGRAPHS 2024 review committee (PC)
...
\item CACM Research Highlight 2026 for egg: Fast and Extensible EqSat
\item SIGPLAN Research Highlight 2025 for egg: Fast and Extensible EqSat
...
\begin{enumerate}
  ...
  \item Andrew Cheung, UCSD PhD Student
  \item Yumeng He, Utah PhD student
  \item Nicole Heinimann, TU Berlin, SIGPLAN-M, June 2024 - current
